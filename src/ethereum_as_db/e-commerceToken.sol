 ...
 */
contract eCommerceToken is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit, ERC20FlashMint {
    ...
    constructor(address initialOwner)
        ERC20("EUROToken", "EURO") // Initializes the ERC-20 token with a name ("EUROToken") and symbol ("EURO").
        Ownable(initialOwner) // Sets the initial owner of the contract.
        ERC20Permit("EUROToken") // Initializes the EIP-2612 permit functionality with the token name.
    {
        _decimal = 2;
    }
