...
contract CallIntefaceCounter {
    ...
    function callContract(address _address_contract) external {
        ...
        IhaciaContratoCounter counter = IhaciaContratoCounter(_address_contract);
