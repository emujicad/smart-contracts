...
contract SupplyChain  is ReentrancyGuard {
    ...
    */
    error ExistingUserWithApprovedRole(); // Si se intenta registrar una empresa con una dirección que ya existe. 
 
    /**
    * @notice El usuario ya tiene el rol solicitado.
    */
    error UserWithExistingRole(); // Si se intenta registrar una empresa con una dirección que ya existe.
...
/* ======================= FUNCIONES PRINCIPALES: ejemplos ======================= */
    ...
    */
    function setPauseRole(address account, PauseRole role) public onlyOwner {
    ...
    */
    function initiateOwnershipTransfer(address newOwner) public onlyOwner whenNotPaused {
    ...
    */
    function requestUserRole(UserRole role) public whenNotPaused { 
        uint256 userId;
    ...
    */
    function changeStatusUser(address userAddress, UserStatus newStatus) public onlyOwner whenNotPaused {
    ...
    */
     ...
     */
    function createToken(string memory name, TokenType tokenType, uint totalSupply, string memory features, uint parentId) public onlyTokenCreators whenNotPaused {
    ...
    */
    function transfer(address to, uint tokenId, uint amount) public whenNotPaused onlyTransfersAllowed nonReentrant{
    ...
    */
    function acceptTransfer(uint transferId) public whenNotPaused onlyReceiverAllowed nonReentrant{
    ...
    *      Requiere que el contrato no esté pausado.
    */
    function rejectTransfer(uint transferId) public whenNotPaused onlyReceiverAllowed nonReentrant {
        Transfer storage transferItem = transfers[transferId];
        require(transferItem.status == TransferStatus.Pending, "Transfer not pending");
    ...
    */
     ...
     * @dev Esta función puede ser costosa en gas con muchos tokens.
     */
    ...
    * @dev Utiliza dos iteraciones/bulces sobre el mapping de transferencias existentes para calcular y copiar los resultados.
    *      Adecuado para volúmenes bajos o consultas off-chain debido al coste gas potencial en loops grandes.
    */
